...
exp_transform_table <- data_process(exp_data, exclude_var_missing=T,
...
tsne_result <- tsne(exp_transform_table, group_info = NULL,
                    sig_feature = NULL, pca=T, perplexity=5,
...
DEspec_PCA <- PCA(exp_transform_table,
                  ...
                  scaling=T, centering=T, group_num=2,
                  cluster_method='kmeans', var1=NULL, var2=NULL,
                  insert_ref_group=NULL, ref_group=NULL,
                  n_PC=c(1,2), top_n_feature=10)
...
exp_transform_table <- data_process(exp_data, exclude_var_missing=T,
                                    missing_pct_limit=50, replace_zero=T,
                                    xmin=0.5, zero2what='min', replace_NA=T,
                                    ymin=0.5, NA2what='min', pct_transform=T,
                                    data_transform=T, trans_type='log',
                                    centering=F, scaling=F)
# data processing of exp_data (without log10 transformation)
exp_transform_non_log <- data_process(exp_data, exclude_var_missing=T,
...
DEspec_tsne <- tsne(exp_transform_table,
                    group_info = group_info,
                    sig_feature=DE_species_table_sig$feature,
                    pca=T, perplexity=5, max_iter=500,
...
DEspec_UMAP <- UMAP(exp_transform_table, group_num=2,
                    ...
                    sig_feature=DE_species_table_sig$feature,
                    metric='euclidean', scale=T, var1=NULL,
...
# data processing of exp_data
exp_transform_table <- data_process(exp_data, replace_zero=T,
                                    exclude_var_missing=T,
                                    missing_pct_limit=50,
                                    zero2what='min',
                                    xmin=0.5, replace_NA=T,
                                    NA2what='min', ymin=0.5,
                                    pct_transform=T, data_transform=T,
...
DE_species_table_sig <- DE_species_2(exp_transform_non_log, data_transform=T,
                                     ...
                                     sig_FC=2)$DE_species_table_sig
# conduct PLSDA
DEspec_PLSDA <- PLSDA(exp_transform_table, scaling=T,
...
exp_transform <- data_process(exp_data, exclude_var_missing=T,
                              ...
                              data_transform=T, trans_type='log',
                              ymin=0.5, centering=F, scaling=F)
# data processing of exp_data (without log10 transformation)
exp_transform_non_log <- data_process(exp_data, exclude_var_missing=T,
                                      missing_pct_limit=50,
                                      replace_zero=T,
...
exp_transform_non_log <- data_process(exp_data, replace_zero=T,
                                      ...
                                      NA2what='min', centering=F,
                                      pct_transform=T, scaling=F,
                                      data_transform=F, trans_type='log')
# filter lipid_char_table according to exp_transform
lipid_char_filter <- lipid_char_table %>%
  filter(feature %in% exp_transform$feature)
...
DE_char_result <- DE_char_2(exp_transform_non_log, data_transform=T,
                            group_info = group_info, paired=F,
                            sig_pvalue=0.05, sig_FC=2,
                            insert_ref_group=NULL, ref_group=NULL)
...
DE.sub.char.2 <- DE_sub_char_2(exp_data, data_transform=T,
                               lipid_char_table=lipid_char_table,
                               split_var = char_var[1],
                               char_var = char_var[4],
                               group_info = group_info,
                               paired=F, sig_pvalue=0.05,
                               sig_FC=2, exclude_var_missing=T,
                               missing_pct_limit=50,
                               replace_zero=T, zero2what='min',
                               xmin=0.5, replace_NA=T,
                               NA2what='min', ymin=0.5,
...
exp_transform_class <- data_process(exp_data_Spe2Char, exclude_var_missing=T,
                                    missing_pct_limit=50, replace_zero=T,
                                    zero2what='NA', xmin=0.5, replace_NA=T,
                                    NA2what='min', ymin=0.5, pct_transform=T,
                                    data_transform=T, trans_type='log',
                                    centering=F, scaling=F)
# data processing of exp_data (without log10 transformation)
...
DEchar_UMAP <- UMAP(exp_transform_class, group_info = group_info,
                    sig_feature = DE_char_table_sig[,1],
                    n_neighbors=15, scale=T, group_num=2,
                    metric = 'euclidean',
                    cluster_method = 'kmeans',
                    var1=NULL, var2=NULL,
                    insert_ref_group=NULL, ref_group=NULL)
...
DEchar_PLSDA <- PLSDA(exp_transform_class, group_info = group_info,
                      sig_feature=DE_char_table_sig[,1],
                      ncomp=2, scaling=T, cluster_method='group_info',
                      group_num = NULL, var1=NULL, var2=NULL,
                      insert_ref_group=NULL, ref_group=NULL)
...
exp_transform_class <- data_process(exp_data_Spe2Char, exclude_var_missing=T,
                                    missing_pct_limit=50, replace_zero=T,
                                    replace_NA=T,zero2what='NA',
                                    NA2what='min', pct_transform=T, xmin=0.5,
                                    data_transform=T, ymin=0.5,
                                    trans_type='log', centering=F, scaling=F)
# data processing of exp_data (without log10 transformation)
exp_transform_non_log <- data_process(exp_data_Spe2Char,
                                      exclude_var_missing=T,
                                      missing_pct_limit=50,
                                      replace_zero=T, zero2what='min',
                                      xmin=0.5, replace_NA=T, NA2what='min',
                                      ymin=0.5, pct_transform=T,
                                      data_transform=F, trans_type='log',
                                      centering=F, scaling=F)
# filter significant lipid characteristics
DE_char_table_sig <- DE_char_2(exp_transform_non_log,
                               data_transform=T, group_info = group_info,
                               paired=F, sig_pvalue=0.05, sig_FC=2
...
ML_data <- ML_data_process(exp_data, group_info = condition_table,
                           lipid_char_table, char_var[1],
                           exclude_var_missing=T, pct_transform=T,
                           missing_pct_limit=50, replace_zero=T,
                           zero2what='min', NA2what='min',
                           xmin=0.5, replace_NA=T, ymin=0.5,
                           data_transform=T, centering=F,
                           trans_type='log', scaling=F)
# conduct machine learning
ML_output <- ML_final(ML_data[[2]], ranking_method='Random_forest',
                      ML_method='Random_forest', split_prop=0.3, nfold=10)
# conduct SHAP
