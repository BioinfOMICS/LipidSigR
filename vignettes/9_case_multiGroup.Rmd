...
description: >
  "LipidSigR" is an R package developed based on LipidSig web-based tool 
   ...
   We provide 5 main analysis workflows, which is "Profiling", "Differential 
   expression", "Enrichment", and "Machine learning". 
vignette: >
...
```{r install package method 2, eval=FALSE}
...
Here, we provide a few steps to help you prepare the data.
...
```{r rgoslin_multiGroup, message = FALSE}
library(dplyr)
...
The following sections sequentially describe the functions within the 4 workflows 
mentioned above.
