...
@
\begin{figure}
   \includegraphics[width=0.7\textwidth]{images/exp_profilling_1.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/exp_profilling_2.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/exp_profilling_3.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/pca_biplot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/pca_screeplot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/pca_variable.png}
...
@
\begin{figure}
  \includegraphics[width=0.6\textwidth]{images/pca_feature_contrib.png}
...
@
\begin{figure}
  \includegraphics[width=0.6\textwidth]{images/tsne_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.6\textwidth]{images/UMAP_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/corr_heatmap_1.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/corr_heatmap_2.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/exp_compo_by_lipidinfo_01.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/exp_compo_by_lipidinfo_02.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_species_dotchart_sig.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_species_maplot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_species_volcano.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEs_PCA_scree_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEs_PCA_correlation_circle.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEs_PCA_contribution.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEs_tsne_plot.png}
  \caption{\textbf{t-SNE plot}}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEs_UMAP_plot.png}
  \caption{\textbf{UMAP plot}}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/PLSDA_sample.plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/PLSDA_variable.plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/Hclustering_all.lipid.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/Hclustering_sig.lipid.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/Sig_lipid_barplot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/Sig_lipid_lollipop.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/Sig_lipid_word.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/enrich_char_barplot.png}
...
<<echo=FALSE, results=verbatim, include=FALSE>>=
# data processing of exp_data
exp_transform <- data_process(exp_data, exclude_var_missing=TRUE,
                              missing_pct_limit=50, replace_zero=TRUE,
                              zero2what='min', xmin=0.5, replace_NA=TRUE,
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_char_barplot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_char_barplot_sqrt.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_char_trendplot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_char_trendplot_sqrt.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_char_boxplot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_sub_char_plot_2_1.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_sub_char_plot_2_4.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_sub_char_plot_2_2.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_sub_char_plot_2_5.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DE_sub_char_plot_2_3.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEc_PCA_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEc_PCA_scree_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEc_PCA_correlation_circle.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEc_PCA_contribution.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEc_tsne_plot.png}
  \caption{\textbf{t-SNE plot}}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEc_UMAP_plot.png}
  \caption{\textbf{UMAP plot}}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEc_PLSDA_sample.plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEc_PLSDA_variable.plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEc_Hclustering_all.lipid.png}
  \caption{\textbf{Heatmap of all lipid species}}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/DEc_Hclustering_sig.lipid.png}
  \caption{\textbf{Heatmap of all lipid species}}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/ROC_mean_AUC_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/ROC_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/PR_mean_AUC_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/PR_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/evalution_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/probability_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/cm_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/feature_freq_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/feature_imp_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/mean_shapley_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/all_shapley_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/SHAP_sample_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/SHAP_f_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.7\textwidth]{images/shap_dependence_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.8\textwidth]{images/corr_network.png}
...
@
\begin{figure}
  \includegraphics[width=0.8\textwidth]{images/Clin_Cor_table_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.8\textwidth]{images/Clin_LR_table_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.8\textwidth]{images/char_Clin_Cor_table_plot.png}
...
@
\begin{figure}
  \includegraphics[width=0.8\textwidth]{images/char_Clin_LR_table_plot.png}
