...
*(NOTE: For constructing the input data for machine learning analysis, please refer to the [next section](#data-ml).)*
...
```{r rgoslin_twoGroup, message = FALSE}
library(dplyr)
