...
test_that("Test for incorrect input and related error messages", {
    expect_error(
        ...
        "The 'char' parameter must be one of the listed lipid characteristics.
        Please use the list_lipid_char() function to view which lipid characteristics can be analyzed."
    )
    expect_error(
