...
#' tsne(exp_transform_table, group_info = NULL, sig_feature = NULL, pca=T, perplexity=5,
#'      max_iter=500, cluster_method='kmeans', group_num = 2, var1 = 'euclidean',
#'      var2 = NULL, insert_ref_group = NULL, ref_group = NULL)
#'
#' }
tsne <- function(exp_transform_table, group_info = NULL, sig_feature = NULL,
  ...
  tsne <- Rtsne::Rtsne(tsne_table,check_duplicates=F , pca=pca,
