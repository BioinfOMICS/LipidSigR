...
deSp_multiGroup <- function(processed_se, ref_group,
    ...
    if(group_type != 'multiple') stop('This function is used for multiple groups. If your data consists of two groups, please use deSp_twoGroup() for analysis.')
