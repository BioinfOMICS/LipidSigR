...
#'     variable, allowing researchers to estimate the associations between lipid 
#'     levels and clinical features. This function prints the heatmap based on 
...
#'     names and clinical conditions (disease status, gene dependence score, etc.)
...
#'     \bold{"BH"}, \bold{"BY"}, \bold{"fdr"}, \bold{"none"}, can be abbreviated. 
#'     (default: "BH")
...
#'     include \bold{"pearson"}, \bold{"kendall"}, \bold{"spearman"}.
#'     (default: "spearman")
