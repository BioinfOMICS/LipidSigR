...
#' including removing features with missing values, imputing missing values, and normalization.
...
#' Allowed methods include "QRILC", "SVD", "KNN", "IRMI", "min", "mean", "median", "PPCA", "BPCA", "RandomForest", and "none".
#' If you have already replaced NAs, select 'none'. Default is \code{'min'}.
